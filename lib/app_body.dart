...
class AppBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final btn1 = RaisedButton(
      ...
      onPressed: () => _showSnackBar('這是RaisedButton按鈕'),
    );
    ...
    final btn2 = FlatButton(
      ...
      padding: EdgeInsets.symmetric(vertical: 10, horizontal: 20),
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(6)),
      onPressed: () => _showSnackBar('這是FlatButton按鈕'),
    );
    ...
    final btn3 = OutlineButton(
      ...
      padding: EdgeInsets.symmetric(vertical: 10, horizontal: 20),
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(6)),
      onPressed: () => _showSnackBar('這是OutlineButton按鈕'),
    );
    ...
    final btn4 = IconButton(
      ...
      color: Colors.blue,
      padding: EdgeInsets.symmetric(vertical: 10, horizontal: 20),
      onPressed: () => _showSnackBar('這是IconButton按鈕'),
    );
...
//      ),
      ...
      elevation: 8,
      shape: CircleBorder(),
      onPressed: () => _showSnackBar('這是FloatingActionButton按鈕'),
    );
